...
class Selector:
    ...
    def xpath(self, xpath_expr: str) -> 'Selector':
        """
        Execute an xpath expression on each element of the Selector

        :param xpath_expr: An xpath expression returning Tags to execute.
        :return: Selector of selected Tags.
        :rtype: Selector
        """